<?php
	...
	function hitung_tagihan_awal($harga, $jumlah){
		return $tagihan_awal = $harga * $jumlah;  
	}
	// pada fungsi ini akan mengembalikan nilai tagihan awal dari hasil perkalian harga dan jumlah
...
<html>
	...
	<div class="container border">
		...
		<!-- ..... -->
		<img src="logo.png" alt="Logo Restoran" width="100px" height="100px">
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			$dataJson = file_get_contents('data.json', true);
